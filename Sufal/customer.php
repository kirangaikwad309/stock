    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">S Rate: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
			 ...
			 <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">D Rate: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="drate" placeholder="Rate" name="drate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
			 <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">R Rate: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rrate" placeholder="Rate" name="rrate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
	        <div class="form-group">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
					...
					<div class="form-group">
						...
						<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="editRate" placeholder="S Rate" name="editRate" autocomplete="off">
							</div>
					</div> <!-- /form-group-->	     	        
					 ...
					 <div class="form-group">
						...
						<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="editdrate" placeholder=" D Rate" name="editdrate" autocomplete="off">
							</div>
					</div> <!-- /form-group-->	    
					 <div class="form-group">
						<label for="rate" class="col-sm-3 control-label">R Rate: </label>
						<label class="col-sm-1 control-label">: </label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="editrrate" placeholder="Rate" name="editrrate" autocomplete="off">
							</div>
					</div> <!-- /form-group-->					
