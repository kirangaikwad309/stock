...
if($_POST) {
	...
	$grandTotalValue = $_POST['grand_total'];
 ...
 $productName=$_POST['productName'];
  ...
  // $paymentStatus 				= $_POST['paymentStatus'];
    ...
    $sql="INSERT INTO purchase ('client_name', 'address', 'country', 'client_contact', 'gstin_bill', 'productName', 'quantity', 'rateValue', 'total_amount', 'grand_total')VALUES ('$clientName', '$address', '$country', '$clientContact', '$gstin_bill', '$productName', '$quantity', '$rateValue', '$totalAmountValue', '$grandTotalValue')";
		// $order_id;
		// $orderStatus = false;
...
//     <td class="tg-yw4l">'.$_POST['taxablevalue'][$x].'</td>
