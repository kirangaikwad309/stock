	...
	<div class="success-messages"></div> <!--/success-messages-->
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createprintinvoice.php" id="printinvoice">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="dateos" name="dateos" placeholder="Date of Supply" autocomplete="off" />
			    </div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="change" >
				      	<option value="" >~~SELECT~~</option>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<!-- <form class="form-horizontal" id="submitCategoriesForm" method="POST"> -->
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Cheque Details</h4>
      </div>
      <div class="modal-body">
        <!-- <p>Cheque details&hellip;</p> -->
				Account no:<input type="text" name="ac_no" value="ac_no"><br><br>
			
				Bank name:<input type="text" name="bnk_nm" value="bnk_nm"><br><br>
				Cheque no:<input type="text" name="chq_no" value="chq_no"><br><br>
        Issue Date: <input type="text" name="i_date" id="datepicker" value="i_date">    
		  </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i> Close</button>
        <button type="submit" name="save" id="mySubmit" value="" class="btn btn-success" data-loading-text="Loading..." autocomplete="off"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">NEFT/RTGS Details</h4>
      </div>
      <div class="modal-body">
        <!-- <p>Cheque details&hellip;</p> -->
				UTR:<input type="text" name="utr" value=""><br><br>
				Transaction id.:<input type="text" name="tid" value=""><br><br>
				
		  </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i>Close</button>
        <button type="submit"  class="btn btn-primary" name="save1" id="mySubmit1" data-loading-text="Loading..."><i class="glyphicon glyphicon-ok-sign"></i>Save</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
